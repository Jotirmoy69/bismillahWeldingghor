  ...
  return (
    <section>
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full relative">
        <div className='flex justify-end absolute top-5  right-5'><button onClick={() => setButton(false)}><RxCross2 className='text-2xl cursor-pointer' /></button></div>
        <h2 className="text-4xl  text-center text-black font-[valorant] mb-6">Add Member</h2>
        <form onSubmit={handleSubmit}>
          {/* Name */}
          <div className="mb-4">
            <label htmlFor="name" className=" font-[valorant] block text-2xl font-medium text-gray-700 mb-2">Name</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          {/* Post */}
          <div className="mb-4">
            <label htmlFor="post" className=" font-[valorant] block text-2xl font-medium text-gray-700 mb-2">Post Title</label>
            <input
              type="text"
              id="post"
              name="post"
          ...
          {/* Description */}
          <div className="mb-4">
            <label htmlFor="description" className=" font-[valorant] block text-2xl font-medium text-gray-700 mb-2">Description</label>
            <textarea
              id="description"
              name="description"
              rows="4"
          ...
          {/* Image */}
          <div className="mb-4">
            <label htmlFor="image" className=" font-[valorant] block text-2xl font-medium text-gray-700 mb-2">Upload Image</label>
            <input
              type="file"
              id="image"
              name="image"
      ...
      <div className='h-scree w-full  py-5'>
        <div className='flex justify-between items-center px-10'>
        <button type="button" onClick={() => setButton(true)} className=" font-[valorant] rounded-lg text-xl px-5 py-2.5 me-2 mb-2 bg-[#C5F1FF] hover:bg-[#ACD6FF] transition-all duration-200 cursor-pointer">Add Member</button>
